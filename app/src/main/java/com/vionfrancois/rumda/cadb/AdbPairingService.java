...
public class AdbPairingService extends Service {
    ...
    public static final String ACTION_PAIRING_RESULT = "com.vionfrancois.rumda.PAIRING_RESULT";
    ...
    public int onStartCommand(@Nullable Intent intent, int flags, int startId) {
        ...
        if (notification != null) {
            try {
                ...
                try {
                    // Fallback without explicit type for devices/builds rejecting the typed call.
